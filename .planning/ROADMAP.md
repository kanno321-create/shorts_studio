...
- [x] 12-02-PLAN.md — Wave 2 Producer 12 migration (Core 5 + Support 7) + skill_patch_counter 확장 + F-D2-EXCEPTION-02 Wave 2 entry (AGENT-STD-01/02, FAIL-PROTO-02)
- [x] 12-03-PLAN.md — Wave 3 Inspector 17 migration (6 카테고리) + F-D2-EXCEPTION-02 Wave 3 supplement (AGENT-STD-01/02, FAIL-PROTO-02)
...
**Plans:** 6/6 plans complete
  ...
  - [x] 13-04-PLAN.md — Wave 3 Budget Cap Enforcement (SMOKE-05 Tier 1 enforcement + provider_rates.py SSOT)
  - [x] 13-05-PLAN.md — Wave 4 Full E2E Smoke (SMOKE-06 phase13_live_smoke.py runner — phase11_full_run.py clone + Wave 0~3 wire)
  - [x] 13-06-PLAN.md — Wave 5 Phase Gate (phase13_acceptance.py aggregator + TRACEABILITY + VALIDATION HARD-GATE flip — phase14_acceptance.py 패턴 복제)
**UI hint:** no
...
| 15. System Prompt Compression + UFL | 4/7 | In Progress|  |
