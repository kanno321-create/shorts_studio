...
VISUAL_SPEC = EPISODE_DIR / "visual_spec_v3_1.json"
SUBTITLES = EPISODE_DIR / "subtitles_remotion_v3_1.json"
SUBTITLES_SRT = EPISODE_DIR / "subtitles_remotion_v3_1.srt"
NARRATION = EPISODE_DIR / "narration_v3.mp3"  # narration unchanged from v3

REMOTION_DIR = Path("remotion")
PUBLIC_DIR = REMOTION_DIR / "public" / EPISODE_ID
PROPS_PATH = EPISODE_DIR / "remotion_props_v3_1.json"
FINAL_RAW = EPISODE_DIR / "final_v3_1_raw.mp4"
FINAL_OUT = EPISODE_DIR / "final_v3_1.mp4"
...
def sync_public_assets() -> None:
    ...
    for src, alias_name in [
        (NARRATION, "narration_v3.mp3"),
        (SUBTITLES, "subtitles_remotion_v3.json"),
    ]:
