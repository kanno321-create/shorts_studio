...
YouTube Shorts 추천 알고리즘 + ranking 요소 (완주율, retention, CTR, 재시청). shorts shelf 진입 조건 + cross-platform 패널티 규칙.
...
- **Agent consumer**: Phase 4 에이전트 prompts가 `@wiki/shorts/algorithm/MOC.md` 형식으로 참조
