...
# YPP (YouTube Partner Program) — Map of Content
...
YouTube Partner Program 진입 조건 + 수익화 모델. Shorts Fund 역사, 한국 RPM 벤치마크, Reused Content 방어 규칙.
...
- **Agent consumer**: Phase 4 에이전트 prompts가 `@wiki/shorts/ypp/MOC.md` 형식으로 참조
