...
status: scaffold
tags: [moc, shorts, continuity_bible]
updated: 2026-04-19
---

# Continuity Bible — Map of Content
...
채널 정체성 고정값 — 색상 팔레트, 카메라 렌즈, 시각 스타일 prefix. 모든 영상/이미지 API 호출 prefix 자동 주입 (D-1 Continuity Bible).
...
- **Agent consumer**: Phase 4 에이전트 prompts가 `@wiki/shorts/continuity_bible/MOC.md` 형식으로 참조
